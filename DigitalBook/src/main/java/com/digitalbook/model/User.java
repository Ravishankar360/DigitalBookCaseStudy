...
public class User {
	...
	public User(Integer userId, Salutation salutation, String firstName, String lastName, String userName,
			String userEmail, String password, String address, String city, String postalCode, Integer mobileNumber,
			Integer is_active, Date cretedAt, Date updateAt) {
		super();
		this.userId = userId;
